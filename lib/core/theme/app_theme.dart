...
// On iOS this resolves to San Francisco (SF Pro), Apple's system font.
// On Android it falls back to Roboto.
final _fontFamily = Platform.isIOS ? '.SF Pro Text' : null;
...
class AppTheme {
  static ThemeData light({Color accent = AppColors.accent}) {
    ...
    return ThemeData(
      ...
      appBarTheme: AppBarTheme(
        ...
        titleTextStyle: const TextStyle(color: textPrimary, fontSize: 17, fontWeight: FontWeight.w600, letterSpacing: -0.4),
  ...
  static ThemeData dark({Color accent = AppColors.accent}) {
    return ThemeData(
      ...
      textTheme: const TextTheme(
        displayLarge: TextStyle(color: AppColors.textPrimary, fontWeight: FontWeight.w700, fontSize: 34, letterSpacing: -0.8),
        titleLarge: TextStyle(color: AppColors.textPrimary, fontWeight: FontWeight.w600, fontSize: 20, letterSpacing: -0.4),
        titleMedium: TextStyle(color: AppColors.textPrimary, fontWeight: FontWeight.w600, fontSize: 16, letterSpacing: -0.2),
        bodyLarge: TextStyle(color: AppColors.textPrimary, fontSize: 16, letterSpacing: -0.2),
        bodyMedium: TextStyle(color: AppColors.textSecondary, fontSize: 14),
        labelLarge: TextStyle(color: AppColors.textPrimary, fontSize: 14, fontWeight: FontWeight.w600, letterSpacing: -0.1),
        labelSmall: TextStyle(color: AppColors.textSecondary, fontSize: 11, letterSpacing: 0.6),
      ),
      ...
      appBarTheme: AppBarTheme(
        ...
        titleTextStyle: const TextStyle(color: AppColors.textPrimary, fontSize: 17, fontWeight: FontWeight.w600, letterSpacing: -0.4),
      ...
      bottomNavigationBarTheme: BottomNavigationBarThemeData(
        ...
        selectedLabelStyle: const TextStyle(fontSize: 11, fontWeight: FontWeight.w600, letterSpacing: -0.1),
      ...
      switchTheme: SwitchThemeData(
        ...
        trackColor: WidgetStateProperty.resolveWith((s) =>
            s.contains(WidgetState.selected) ? accent : AppColors.surfaceHigh),
        trackOutlineColor: WidgetStateProperty.all(Colors.transparent),
      ),
